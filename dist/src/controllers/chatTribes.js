    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            asyncForEach(msgs, (m) => __awaiter(this, void 0, void 0, function* () {
                ...
                const sender = Object.assign(Object.assign(Object.assign(Object.assign({}, owner), { alias: m.senderAlias || '' }), { role: constants_1.default.chat_roles.reader }), { photoUrl: m.senderPic || '' });
                let content = '';
                try {
