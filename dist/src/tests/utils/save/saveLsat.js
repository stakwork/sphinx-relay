...
const macaroonSigningKey = (0, crypto_1.randomBytes)(32).toString('hex');
const macaroonFromInvoice = (t, payreq) => {
    var _a;
    const invoice = (0, bolt11_1.decode)(payreq);
...
const saveLsat = (t, payer, receiver) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { lsat: token } = yield (0, helpers_1.makeRelayRequest)('post', '/lsats', payer, args);
