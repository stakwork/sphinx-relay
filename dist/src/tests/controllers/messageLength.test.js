...
function messageLengthTest(t, node1, node2) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield del_1.deleteMessages(t, node2);
        ...
        yield msg_1.sendMessage(t, node1, node2, text);
        yield helpers_1.sleep(1000);
        const text2 = helpers_1.randomText();
        yield msg_1.sendMessage(t, node1, node2, text2);
        yield helpers_1.sleep(1000);
        const text3 = helpers_1.randomText();
        yield msg_1.sendMessage(t, node1, node2, text3);
        yield helpers_1.sleep(1000);
        const text4 = helpers_1.randomText();
        yield msg_1.sendMessage(t, node1, node2, text4);
        yield helpers_1.sleep(1000);
        //t.true(messageSent.success, 'node1 should send text message to node2')
        const newMessagesResponse = yield get_1.getCheckMsgs(t, node2, date, limit, offset, 'desc');
        ...
        const newMessagesResponse2 = yield get_1.getCheckAllMessages(t, node2, limit, offset, 'desc');
...
function longMessage(t, node1, node2) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield msg_1.sendMessage(t, node1, node2, longText);
        yield helpers_1.sleep(1000);
        //Checking for the new long message
        const onlyMessage = yield get_1.getCheckAllMessages(t, node2, limit, offset, 'desc');
