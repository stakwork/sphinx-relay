...
function testSocketIO(t, legacy) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        t.true(responseArray[responseArray.length - 4].type == 'message', 'we should receive a confirmation');
        t.true(responseArray[responseArray.length - 3].type == 'group_join', 'we should receive a message');
        t.true(responseArray[responseArray.length - 2].type == 'confirmation', 'we should get back something when we join a tribe group chat');
