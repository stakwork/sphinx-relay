...
function testSocketIO(t, legacy) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        io.connect();
        yield save_1.addContact(t, nodes_1.default[0], nodes_1.default[1]);
        //*******
        //Receive payment
        //payment.ts
        const amount = 101;
        const paymentText = 'this eleven payment';
        yield msg_1.sendPayment(t, nodes_1.default[0], nodes_1.default[1], amount, paymentText);
        const payment = yield msg_1.sendPayment(t, nodes_1.default[0], nodes_1.default[1], amount, paymentText);
        ...
        //messages.ts
        //********
        const messageText = helpers_1.randomText();
        const sentMessage = yield msg_1.sendMessageAndCheckDecryption(t, nodes_1.default[0], nodes_1.default[1], messageText);
        t.true(responseArray[responseArray.length - 1].type == 'message', 'we should get back something when we recieve a message');
        //*****
        //recieve boost
        //messages.ts
        //*******
        const socketTribe = yield save_1.createTribe(t, nodes_1.default[0]);
        yield save_1.joinTribe(t, nodes_1.default[1], socketTribe);
        const tribeMessage = yield msg_1.sendTribeMessage(t, nodes_1.default[1], socketTribe, messageText);
        yield msg_1.sendBoost(t, nodes_1.default[0], nodes_1.default[1], tribeMessage, 10, socketTribe);
        ...
        yield del_1.deleteMessage(t, nodes_1.default[0], sentMessage.id);
        yield helpers_1.sleep(1000);
        t.true(responseArray[responseArray.length - 1].type == 'delete', 'we should get back a delete type');
        /*******
         * Recieve Invoice
         */
        yield msg_1.sendInvoice(t, nodes_1.default[0], nodes_1.default[1], 11, 'Invoice sample text');
        yield helpers_1.sleep(1000);
        t.true(responseArray[responseArray.length - 1].type == 'invoice', 'we should get back a invoice type');
        /*
         * Recieve Purchase
         */
        yield msg_1.sendImage(t, nodes_1.default[0], nodes_1.default[1], base64images_1.greenSquare, null, 10);
        yield helpers_1.sleep(1000);
        ...
        yield msg_1.sendImage(t, nodes_1.default[1], nodes_1.default[0], base64images_1.greenSquare, null, 10);
        yield helpers_1.sleep(1000);
        ...
        t.true(responseArray[responseArray.length - 1].type == 'purchase_accept', 'we should get back a purchase_accept type');
        yield save_1.joinTribe(t, nodes_1.default[2], socketTribe);
        yield del_1.leaveTribe(t, nodes_1.default[2], socketTribe);
        ...
        yield del_1.deleteTribe(t, nodes_1.default[0], socketTribe);
        yield helpers_1.sleep(1000);
