...
ava_1.default.serial('cleanup contacts', (t) => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, helpers_1.asyncForEach)(nodes_1.default, (node1) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        for (const contact of allContacts) {
            if (contact.public_key !== node1.pubkey) {
                const ok = yield (0, del_1.deleteContact)(t, node1, contact.id);
                t.true(ok);
            }
        }
    }));
...
ava_1.default.serial('cleanup chats', (t) => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, helpers_1.asyncForEach)(nodes_1.default, (node1) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const allChats = yield (0, get_1.getChats)(t, node1);
        for (const chat of allChats) {
            const ok = yield (0, del_1.deleteChat)(t, node1, chat.id);
            t.true(ok);
        }
    }));
}));
