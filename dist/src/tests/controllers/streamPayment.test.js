...
*/
ava_1.default('test-20-streamPayment: establish chat, node1 streams payment, node1 streams split payment, delete contacts', (t) => __awaiter(void 0, void 0, void 0, function* () {
...
function streamPayment(t, node1, node2, node3) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        var stream1 = yield msg_1.payStream(t, node1, node2, null, 14);
        t.true(stream1);
        //STREAM SPLIT PAYMENT FROM NODE1 TO NODE2 AND NODE3 (50% SPLIT)
        var stream2 = yield msg_1.payStream(t, node1, node2, node3, 14);
        t.true(stream2);
