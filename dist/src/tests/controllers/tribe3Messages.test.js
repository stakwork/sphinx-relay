...
*/
ava_1.default('test-10-tribe3Msgs: create tribe, two nodes join tribe, send messages, 2 nodes leave tribe, delete tribe', (t) => __awaiter(void 0, void 0, void 0, function* () {
...
function tribe3Msgs(t, node1, node2, node3) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        //CHECK THAT NODE1'S DECRYPTED MESSAGE IS SAME AS INPUT
        const n3check = yield msg_1.checkMessageDecryption(t, node3, tribeMessage.uuid, text);
        ...
        let tribeMessage2 = yield msg_1.sendTribeMessage(t, node2, tribe, text2);
        //CHECK THAT NODE2'S DECRYPTED MESSAGE IS SAME AS INPUT
        const n1check = yield msg_1.checkMessageDecryption(t, node1, tribeMessage2.uuid, text2);
        t.true(n1check, 'node1 should have read and decrypted node2 message');
        //CHECK THAT NODE2'S DECRYPTED MESSAGE IS SAME AS INPUT
        const n3check2 = yield msg_1.checkMessageDecryption(t, node3, tribeMessage2.uuid, text2);
        ...
        let tribeMessage3 = yield msg_1.sendTribeMessage(t, node3, tribe, text3);
        //CHECK THAT NODE3'S DECRYPTED MESSAGE IS SAME AS INPUT
        const n1check2 = yield msg_1.checkMessageDecryption(t, node1, tribeMessage3.uuid, text3);
        t.true(n1check2, 'node1 should have read and decrypted node3 message');
        //CHECK THAT NODE2'S DECRYPTED MESSAGE IS SAME AS INPUT
        const n2check2 = yield msg_1.checkMessageDecryption(t, node2, tribeMessage3.uuid, text3);
      ...
      ******/
        ...
        const tribeSeverAddChannelResponse = yield http.post(node1.external_ip + '/tribe_channel', helpers_1.makeArgs(node1, createChannelBody));
        const tribeSeverAddChannelResponse2 = yield http.post(node1.external_ip + '/tribe_channel', helpers_1.makeArgs(node1, createChannelBody2));
        ...
        const r = yield get_1.getCheckTribe(t, node1, tribe.id);
        const channelTribe = yield get_1.getTribeByUuid(t, r);
        ...
        let tribeMessage4 = yield msg_1.sendTribeMessage(t, node3, tribe, text4, options);
        const recivedMessageFromNode1 = yield get_1.getCheckNewMsgs(t, node1, tribeMessage4.uuid);
        const recivedMessageFromNode2 = yield get_1.getCheckNewMsgs(t, node1, tribeMessage4.uuid);
        ...
        //CHECK THAT NODE3'S DECRYPTED MESSAGE IS SAME AS INPUT
        const n1check3 = yield msg_1.checkMessageDecryption(t, node1, tribeMessage4.uuid, text4);
        t.true(n1check3, 'node1 should have read and decrypted node3 message');
        //CHECK THAT NODE2'S DECRYPTED MESSAGE IS SAME AS INPUT
        const n2check3 = yield msg_1.checkMessageDecryption(t, node2, tribeMessage4.uuid, text4);
        ...
        yield http.del(node1.external_ip + '/tribe_channel', helpers_1.makeArgs(node1, deleteChannel1Body));
        yield http.del(node1.external_ip + '/tribe_channel', helpers_1.makeArgs(node1, deleteChannel2Body));
        const channelTribe2 = yield get_1.getTribeByUuid(t, r);
