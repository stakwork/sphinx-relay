...
*/
ava_1.default('test tribeImages: create tribe, join tribe, send images, leave tribe, delete tribe', (t) => __awaiter(void 0, void 0, void 0, function* () {
...
function tribeImages(t, node1, node2) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const imageSent = yield msg_1.sendImage(t, node1, node2, image, tribe);
        t.true(imageSent, 'message should have been sent');
        //NODE2 SENDS AN IMAGE TO NODE1
        const image2 = base64images_1.pinkSquare;
        const imageSent2 = yield msg_1.sendImage(t, node2, node1, image2, tribe);
