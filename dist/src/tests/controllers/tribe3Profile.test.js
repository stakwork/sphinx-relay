...
*/
ava_1.default('test-14-tribe3Profile: create tribe, two nodes join tribe, change alias and profile pic, check change, delete tribe', (t) => __awaiter(void 0, void 0, void 0, function* () {
...
function tribe3Profile(t, node1, node2, node3) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const oldSelf = yield get_1.getSelf(t, node1);
        ...
        let tribeMessage = yield msg_1.sendTribeMessage(t, node1, tribe, text);
        //CHECK THAT NODE1'S DECRYPTED MESSAGE IS SAME AS INPUT
        const n2check = yield msg_1.checkMessageDecryption(t, node2, tribeMessage.uuid, text);
        t.true(n2check, 'node2 should have read and decrypted node1 message');
        const lastMsg = yield get_1.getCheckNewMsgs(t, node2, tribeMessage.uuid);
        ...
        const change1 = yield save_1.updateProfile(t, node1, newAlias);
        ...
        const change2 = yield save_1.updateProfile(t, node1, newPhotoUrl);
        t.true(change2, 'node1 should have changed its profile pic');
        //NODE1 SENDS A TEXT MESSAGE IN TRIBE
        const text2 = helpers_1.randomText();
        let tribeMessage2 = yield msg_1.sendTribeMessage(t, node1, tribe, text2);
        //CHECK THAT NODE1'S DECRYPTED MESSAGE IS SAME AS INPUT
        const n2check2 = yield msg_1.checkMessageDecryption(t, node2, tribeMessage2.uuid, text2);
        t.true(n2check2, 'node2 should have read and decrypted node1 message');
        const lastMsg2 = yield get_1.getCheckNewMsgs(t, node2, tribeMessage2.uuid);
        ...
        let tribeMessage3 = yield msg_1.sendTribeMessage(t, node2, tribe, text3);
        //NODE1 CHECK THAT NODE2'S DECRYPTED MESSAGE IS SAME AS INPUT
        const n1check = yield msg_1.checkMessageDecryption(t, node1, tribeMessage3.uuid, text3);
        t.true(n1check, 'node1 should have read and decrypted node2 message');
        const lastMsg3 = yield get_1.getCheckNewMsgs(t, node1, tribeMessage3.uuid);
        ...
        const n3check = yield msg_1.checkMessageDecryption(t, node3, tribeMessage3.uuid, text3);
        t.true(n3check, 'node3 should have read and decrypted node2 message');
        const lastMsg4 = yield get_1.getCheckNewMsgs(t, node3, tribeMessage3.uuid);
        ...
        const change3 = yield save_1.updateProfile(t, node2, newAlias2);
        t.true(change3, 'node2 should have changed its alias');
        //NODE2 CHANGES PROFILE PIC URL
        let change4 = yield save_1.updateProfile(t, node2, newPhotoUrl);
        t.true(change4, 'node2 should have changed its profile pic');
        //NODE2 SENDS A TEXT MESSAGE IN TRIBE
        const text4 = helpers_1.randomText();
        let tribeMessage4 = yield msg_1.sendTribeMessage(t, node2, tribe, text4);
        //NODE1 CHECK THAT NODE2'S DECRYPTED MESSAGE IS SAME AS INPUT
        const n1check2 = yield msg_1.checkMessageDecryption(t, node1, tribeMessage4.uuid, text4);
        t.true(n1check2, 'node1 should have read and decrypted node2 message');
        const lastMsg5 = yield get_1.getCheckNewMsgs(t, node1, tribeMessage4.uuid);
        ...
        //NODE3 CHECK THAT NODE2'S DECRYPTED MESSAGE IS SAME AS INPUT
        const n3check2 = yield msg_1.checkMessageDecryption(t, node3, tribeMessage4.uuid, text4);
        t.true(n3check2, 'node3 should have read and decrypted node2 message');
        const lastMsg6 = yield get_1.getCheckNewMsgs(t, node3, tribeMessage4.uuid);
        ...
        let reset3 = yield save_1.updateProfile(t, node2, oldAlias2);
        t.true(reset3, 'node2 should have reset its old alias');
        const oldPhotoUrl2 = { photo_url: oldPic2 };
        let reset4 = yield save_1.updateProfile(t, node2, oldPhotoUrl2);
