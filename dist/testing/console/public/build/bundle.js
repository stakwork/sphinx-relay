var app = (function () {
    ...
    const b = [], y = [], v = [], x = [], _ = Promise.resolve();
    let k = !1;
    function w(t) {
        v.push(t);
    }
    ...
    function T() {
        if (!S) {
            ...
            do {
                ...
                for (m(null), b.length = 0; y.length;)
                    y.pop()();
    ...
    function P(t) {
        ...
        return {
            c() {
                ...
                (e = a('div')),
                    (n = d(f)),
                    p(e, 'class', (o = s(t[1] === t[5] ? 'tab selected' : 'tab') + ' svelte-18t8n6f'));
            },
            m(t, o) {
                var s, u, f, a;
                i(t, e, o),
        ...
        return {
            c() {
                ...
                (o = $()),
                    ...
                    p(r, 'style', (l = `left:${e[3]}px;display:${e[3] < 0 ? 'none' : 'block'};`)),
    ...
    function F(t, e, n) {
        let o, { tabs: r = [] } = e, { selected: l = '' } = e, { onSelect: s = () => { } } = e;
        return ((t.$$set = (t) => {
    ...
    function J(t) {
        let e, n, o, r = t[6].text + '';
        return {
            c() {
                ;
                (e = a('span')),
                    (n = d(r)),
                    p(e, 'style', (o = `color:${'error' === t[6].type ? 'red' : 'whitesmoke'};`));
            },
            m(t, o) {
                i(t, e, o), c(e, n);
            },
    ...
    function Q(t, e, n) {
        let o, r, { nodes: l = [] } = e, { logs: s = {} } = e, { initialSelectedTab: c = '' } = e;
        return ((t.$$set = (t) => {
    ...
    function U(t) {
        let e, n, o, r, l;
        return ((n = new R({ props: { nodes: t[1], logs: t[0] } })),
