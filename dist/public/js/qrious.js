...
!(function (t, e) {
    ...
    function e(e, n, s, r) {
        var o = this;
        return ('string' != typeof e && ((r = s), (s = n), (n = e), (e = null)),
            'function' != typeof n &&
                ((r = s),
                    (s = n),
                    (n = function () {
    ...
    var h = n, f = h.extend(function (t, e, i) {
        ...
        for (this._badness = [],
            ...
            this._value = t.value,
            this._version = 0,
            this._stringBuffer = []; this._version < 40 &&
            (this._version++,
        ...
        _pack: function () {
            var t, e, i, n = 1, s = 1, r = this.width, o = r - 1, a = r - 1, h = (this._dataBlock + this._eccBlock) *
