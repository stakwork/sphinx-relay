...
import type { HTLC as _lnrpc_proxy_HTLC, HTLC__Output as _lnrpc_proxy_HTLC__Output } from '../lnrpc_proxy/HTLC';
import type { CommitmentType as _lnrpc_proxy_CommitmentType } from '../lnrpc_proxy/CommitmentType';
import type { ChannelConstraints as _lnrpc_proxy_ChannelConstraints, ChannelConstraints__Output as _lnrpc_proxy_ChannelConstraints__Output } from '../lnrpc_proxy/ChannelConstraints';
...
export interface Channel {
  ...
  'commitment_type'?: (_lnrpc_proxy_CommitmentType | keyof typeof _lnrpc_proxy_CommitmentType);
