...
import type { InvoiceHTLC as _lnrpc_proxy_InvoiceHTLC, InvoiceHTLC__Output as _lnrpc_proxy_InvoiceHTLC__Output } from '../lnrpc_proxy/InvoiceHTLC';
...
export enum _lnrpc_proxy_Invoice_InvoiceState {
  OPEN = 0,
  SETTLED = 1,
  CANCELED = 2,
  ACCEPTED = 3,
...
export interface Invoice {
  ...
  'state'?: (_lnrpc_proxy_Invoice_InvoiceState | keyof typeof _lnrpc_proxy_Invoice_InvoiceState);
