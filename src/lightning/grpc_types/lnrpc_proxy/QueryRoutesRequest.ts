...
import type { FeeLimit as _lnrpc_proxy_FeeLimit, FeeLimit__Output as _lnrpc_proxy_FeeLimit__Output } from '../lnrpc_proxy/FeeLimit';
import type { EdgeLocator as _lnrpc_proxy_EdgeLocator, EdgeLocator__Output as _lnrpc_proxy_EdgeLocator__Output } from '../lnrpc_proxy/EdgeLocator';
import type { NodePair as _lnrpc_proxy_NodePair, NodePair__Output as _lnrpc_proxy_NodePair__Output } from '../lnrpc_proxy/NodePair';
...
export interface QueryRoutesRequest {
  ...
  'dest_features'?: (_lnrpc_proxy_FeatureBit | keyof typeof _lnrpc_proxy_FeatureBit)[];
}
