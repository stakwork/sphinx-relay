...
export async function joinTribe(req: Req, res: Response): Promise<void> {
...
export async function createChannel(req: Req, res: Response): Promise<void> {
  if (!req.owner) return failure(res, 'no owner')
  const owner = req.owner
  //const tenant: number = req.owner.id
...
export async function deleteChannel(req: Req, res: Response): Promise<void> {
  if (!req.owner) return failure(res, 'no owner')
...
export async function pinToTribe(req: Req, res: Response): Promise<void> {
  if (!req.owner) return failure(res, 'no owner')
  const tenant: number = req.owner.id
  const { pin } = req.body
  const { id } = req.params
...
export async function editTribe(req: Req, res: Response): Promise<void> {
  if (!req.owner) return failure(res, 'no owner')
  const tenant: number = req.owner.id
  const {
    name,
...
export async function approveOrRejectMember(req: Req, res: Response): Promise<void> {
  if (!req.owner) return failure(res, 'no owner')
  const tenant: number = req.owner.id
