...
import type {
  CommitmentType as _lnrpc_proxy_CommitmentType,
  CommitmentType__Output as _lnrpc_proxy_CommitmentType__Output,
} from '../lnrpc_proxy/CommitmentType'
import type {
...
export interface Channel {
  ...
  commitment_type?: _lnrpc_proxy_CommitmentType
...
export interface Channel__Output {
  ...
  uptime: string
  close_address: string
  commitment_type: _lnrpc_proxy_CommitmentType__Output
