...
import type {
  PayStatus as _greenlight_PayStatus,
  PayStatus__Output as _greenlight_PayStatus__Output,
} from '../greenlight/PayStatus'
import type {
...
export interface Payment__Output {
  ...
  status: _greenlight_PayStatus__Output
