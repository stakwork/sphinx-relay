...
import type {
  InvoiceStatus as _greenlight_InvoiceStatus,
  InvoiceStatus__Output as _greenlight_InvoiceStatus__Output,
} from '../greenlight/InvoiceStatus'
...
export interface Invoice {
  ...
  status?: _greenlight_InvoiceStatus
  payment_time?: number
  expiry_time?: number
  bolt11?: string
...
export interface Invoice__Output {
  ...
  status: _greenlight_InvoiceStatus__Output
  payment_time: number
  expiry_time: number
  bolt11: string
  payment_hash: Buffer
